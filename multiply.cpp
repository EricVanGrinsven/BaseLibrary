std::string multiply( std::string num1, int base1, std::string num2, int base2, int base3 ) {
...
//Multiplying numbers of the same base, and keeping them in the same base
